...
- **On the Perception Bottleneck of VLMs for Chart Understanding** (2025, Arxiv) — *First author.* Co-authors: Weihao Zeng, Xiwen Zhang, Yijun Wang, Zifei Shan, Junxian He. Has a GitHub code repository: Vision4Chart.
- **On the Universal Truthfulness Hyperplane Inside LLMs** (EMNLP 2024) — *First author.* Co-authors: Shiqi Chen, Yu Cheng, Junxian He. Has a GitHub code repository: Universal_Truthfulness_Hyperplane.
...
A full list of publications is also available on the [Publications](/LJT-Homepage/publications/) page.
